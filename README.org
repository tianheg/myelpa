* myelpa
Emacs package repository backup used by [[https://github.com/tianheg/emacs.d]]
* Usage
...
(add-to-list 'package-archives
             ("myelpa" . "https://raw.githubusercontent.com/tianheg/myelpa/main/" ))
#+end_src
** Used as local repository
Step 1, run below command in shell,
#+begin_src bash
git clone https://github.com/tianheg/myelpa.git /what-ever-directory-you-like/myelpa
#+end_src
